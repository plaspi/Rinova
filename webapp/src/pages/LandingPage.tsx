...
export default function LandingPage() {
    ...
    return (
        <div className="w-full! min-h-screen bg-background! text-foreground! font-sans overflow-x-hidden transition-colors duration-300">
            ...
            {/* --- 3. SHOWCASE MOCKUP --- */}
            <section id="showcase" className="relative w-full max-w-350 mx-auto px-6 py-16 z-10 flex justify-center">

                <div className="absolute inset-24 bg-primary/25! dark:bg-primary/10! blur-[100px] rounded-full z-0 pointer-events-none"></div>

                <div className="relative z-10 w-full max-w-5xl bg-card! border! border-border/50! rounded-2xl overflow-hidden shadow-2xl shadow-primary/5!">
                    ...
                    <div className="w-full bg-muted/30! flex items-center justify-center">
                        ...
                        <video
                            ...
                            playsInline
                        >
                            <source src="/landingpage/videos/demo.mp4" type="video/mp4" />
