        ...
        <CardContent className="grid gap-3 p-0">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1">
              ...
              <Input id="email" type="email" placeholder="mail@example.com" className="h-9" {...register("email")} />
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1">
              ...
              <Input id="name" placeholder="Mario" className="h-9" {...register("name")} />
              {errors.name && <p className="text-[10px] text-destructive">{errors.name.message}</p>}
            </div>
            <div className="space-y-1">
              <Label htmlFor="surname" className="text-xs">Cognome</Label>
              <Input id="surname" placeholder="Rossi" className="h-9" {...register("surname")} />
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1">
              ...
              <Input id="fiscalCode" placeholder="RSSMRA..." className="h-9 uppercase font-mono" maxLength={16} {...register("fiscalCode")} />
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center h-9 w-full rounded-md border border-input bg-transparent shadow-sm focus-within:ring-1 focus-within:ring-ring focus-within:border-primary">
                ...
                <input 
                  id="phoneNumber" 
                  type="tel"
                  className="flex-1 bg-transparent px-3 py-1 text-sm outline-none placeholder:text-muted-foreground w-full h-full rounded-r-md"
          ...
          <div className="space-y-1 pt-1">
            <div className="grid grid-cols-[2fr_0.7fr_1fr] gap-3 items-start relative">
              ...
              <div className="space-y-1">
                ...
                <Input id="street_name" placeholder="Via Roma" className="h-9" {...register("street_name")} />
              ...
              <div className="space-y-1">
                ...
                <Input id="street_number" placeholder="10" className="h-9" {...register("street_number")} />
