...
tutte le principali operazioni (accesso, navigazioni)
in un tempo inferiore ai 2 secondi o nel caso di operazioni pesanti (grosse aggregazioni di dati, creazione KPI)
...
che deve supportare un carico massimo di 100 utenti attivi negli ultimi minuti. La struttura del sistema deve 
...
del numero di:
\begin{itemize}
    \item utenti (cittadini, enti, CER)
    \item richieste simultanee ai servizi offerti dal software
    \item dati energetici
\end{itemize}
Il sistema deve poter essere facilmente esteso ad un maggior parco d'utenza%a nuovi \textbf{comuni o regioni}
senza modifiche sostanziali all'infrastruttura.
\subsection*{RNF-04-Affidabilità}
Il sistema deve garantire un livello di disponibilità non inferiore al 99.9\%,
che corrisponde ad un downtime massimo di 8 ore, 45 minuti, 36 secondi su base annua o circa 43 minuti su base mensile.
...
resistenti ad attacchi di forza bruta.
...
\end{comment}
\subsection*{RNF-07-Manutentibilità}
...
tecnici o avvezzi a questi tipi di tecnologie.
\subsection*{RNF-09-Interoperabilità}
...
\subsection*{RNF-10-Tracciabilità delle operazioni}
Tutte le operazioni critiche (operazioni CRUD)
...
\subsection*{RNF-11-Responsività}
...
dei cittadini.
\subsection*{RNF-12-Gestione errori}
