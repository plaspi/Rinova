...
Il sistema deve permettere ad un utente di cercare una CER attraverso il suo nome o codice identificativo.

\subsubsection*{RF-09-Richiesta adesione CER}
Il sistema deve permettere ad un un utente di fare richiesta di adesione per una CER, verrà posto nella lista delle richieste d'adesione della CER, in attesa di una risposta da parte di un amministratore di quella comunità.
...
\subsubsection*{RF-11-Approvazione richieste di adesione}
...
% è più lato utente non amministratore \subsubsection*{RF-07-Gestione impianti energetici}
...
%da controllare
\subsubsection*{RF-12-Monitoraggio stato impianti}
...
\subsubsection*{RF-13-Gestione dati energetici e reportistica}
...
\subsubsection*{RF-14-Analisi dei benefici energetici ed economici}
...
% è PIù PER L'UTENTE
%\subsubsection*{RF-11-Visualizzazione dati energetici personali}
...
%non presente
%\subsubsection*{RF-12-Confronto con la comunità}
...
Il sistema deve notificare ai membri eventi rilevanti, come l’aggiunta di una comunicazione, un avviso o l’approvazione di una richiesta. Le notifiche devono essere consultabili nell' area notifica e visualizzate con un contatore di elementi non letti.
\subsubsection*{RF-16-Partecipazione e segnalazioni}
Il sistema deve consentire ai membri di inviare segnalazioni o richieste di supporto tecnico/amministrativo all’amministratore della CER%o al rappresentante del Comune
. Le segnalazioni devono includere titolo, descrizione, eventuali allegati. %, e devono essere tracciate con uno stato (inviata, presa in carico, risolta).
