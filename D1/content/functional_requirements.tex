...
Il sistema deve consentire all’amministratore della comunità di visualizzare l’elenco dei membri appartenenti alla CER, con la possibilità di modificarne lo stato. Per ogni membro devono essere mostrati i dati identificativi, i punti di consumo o produzione associati e lo stato della loro partecipazione (attivo, in attesa, sospeso). Le operazioni di modifica.
