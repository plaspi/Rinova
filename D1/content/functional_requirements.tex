...
Il sistema deve consentire agli utenti di poter modificare o eliminare, a patto che non siano dati obbligatori, i propri dati personali e d'accesso tramite l'area personale dedicata come specificato da requisito RF-03.
...
\subsubsection*{RF-10-Apertura ticket segnalazioni}
Il sistema deve permettere ad un utente di aprire un ticket di segnalazione al fine di richiedere supporto tecnico ed amministrativo. Deve inoltre garantirne la persistenza dei dati e del suo stato.

\subsection{Requisiti per Admin della CER}
\subsubsection*{RF-11-Gestione membri della CER}
Il sistema deve consentire all’amministratore della comunità di visualizzare l’elenco dei membri appartenenti alla CER, con la possibilità di modificarne lo stato. Per ogni membro devono essere mostrati i dati identificativi, la data d'iscrizione e lo stato della loro partecipazione (attivo, in attesa, sospeso).
\subsubsection*{RF-12-Gestione richieste di adesione}
Il sistema deve consentire all’amministratore di approvare o rifiutare le richieste di adesione alla CER. Le richieste devono contenere i dati dell’utente e le informazioni necessarie alla valutazione (es. nome, cognome, indirizzo). In caso di approvazione, il sistema deve inviare una notifica email all’utente e aggiornarne lo stato a “membro attivo”.
\subsubsection*{RF-13-Visualizzazione dati energetici e reportistica}
...
\subsubsection*{RF-14-Gestione bacheca avvisi}
...
\subsubsection*{RF-15-Visualizzazione notifiche}
...
\subsubsection*{RF-16-Notifiche e avvisi}
...
\subsubsection*{RF-17-Partecipazione e segnalazioni}
...
\subsubsection*{RF-18-Abbandona CER}
...
\subsubsection*{RF-AS-05-Gestione ticket di supporto}
Il sistema deve consentire all'amministratore di sistema di vsualizzare, rispondere e modificare lo stato dei ticket di supporto aperti dagli utenti.