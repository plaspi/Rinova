...
\subparagraph*{Descrizione:}
\begin{enumerate}
    \item L’utente visualizza la schermata di login con campi Email/Username e Password e opzioni di autenticazione esterna (Google, Facebook, AppleID, ecc.).
    \item L’utente inserisce Email e Password e preme ``Login''.
