...
\begin{enumerate}
    ...
    \item \textbf{Sospensione:} L'utente seleziona un impianto esistente e modifica lo stato operativo in "Sospeso". Il sistema aggiorna lo stato e interrompe temporaneamente il calcolo della produzione per quell'impianto.
    \item \textbf{Rimozione:} L'utente seleziona l'opzione di rimozione per un impianto non più operativo. Il sistema richiede una conferma esplicita e, dopo l'approvazione, rimuove o archivia l'impianto.
\end{enumerate}
...
\subsubsection*{UCD- – Visualizzazione dati e comunicazione}
\begin{itemize}
    \item RF-12 – Visualizzazione dati energetici e reportistica
    \item RF-13 – Gestione bacheca avvisi
    \item RF-14 - Visualizza notifiche
\end{itemize}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/use_case/ucd_05darinominare.pdf}
    \caption{UCD-05 – Gestione e approvazione membri della CER}
    \label{fig:ucd03}
\end{figure}

% ------------------------
\paragraph*{Use Case RF-12: Visualizzazione dati energetici e reportistica}
\subparagraph*{Riassunto:}
...
% ------------------------
\paragraph*{Use Case RF-13: Gestione bacheca avvisi}
\subparagraph*{Riassunto:}
...
\subparagraph*{Descrizione:}
\begin{enumerate}
    \item \textbf{Pubblicazione:} L'amministratore seleziona il pulsante "+" e compila i campi obbligatori: Titolo, Testo del messaggio e Tipo (es. Info, Avviso, Manutenzione, Evento). Alla conferma, il sistema pubblica il messaggio rendendolo visibile a tutti i membri e invia una notifica (cfr. RF-15).
...
% ------------------------
\paragraph*{Use Case RF-14: Visualizza notifiche}
\subparagraph*{Riassunto:}
...
%NON PRESENTE E SPOSTATO ALL'UTENTE
\begin{comment}
% ------------------------
...
\begin{enumerate}
    ...
    \item L'amministratore può visualizzare il messaggio inviato nell'apposita sezione.
\end{enumerate}

% ------------------------
% Diagramma UCD-04
% ------------------------
\subsubsection*{UCD-04 – Abbandono CER}
\begin{itemize}
    \item RF-16 – Abbandono CER
\end{itemize}

\begin{figure}[H]
    \centering
    % Assicurati di salvare l'immagine come ucd_04.pdf
    \includegraphics[width=0.9\textwidth]{images/use_case/ucd_12.pdf}
    \caption{UCD-04 – Abbandono CER}
    \label{fig:ucd04}
\end{figure}
...
\paragraph*{Use Case RF-16: Abbandono CER}
\subparagraph*{Riassunto:}
...
% ------------------------
% Diagramma UCD-05 (Super Admin)
% ------------------------
\subsubsection*{UCD-05 – Gestione Piattaforma (Super Admin)}
\begin{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/use_case/ucd_11.pdf}
    \caption{UCD-05 – Gestione Piattaforma }
    \label{fig:ucd05}
\end{figure}
