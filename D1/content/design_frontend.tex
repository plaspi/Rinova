...
La tabella "Elenco Partecipanti" mostra tutti gli utenti iscritti, permettendo di visualizzarne i dettagli e lo stato (es. "Attivo"), per gli admin è inoltre permesso modificare lo stato dei membri.
...
\textbf{RF-18 - Abbandona CER:}
Nella parte alta, sulla destra è presente un menu (3 puntini) di Gestione Iscrizione da dove è possibile Abbandonare la propria CER in qualsiasi momento.
